...
required_files=(
  ...
  "src/physics/pulse_accounting.py"
  "src/physics/beam_geometry.py"
  "src/physics/atmospheric_channel.py"
  "src/physics/detector_nonidealities.py"
  "src/physics/journal_grade_model.py"
  "scripts/runpod/run_journal_grade_validation.sh"
